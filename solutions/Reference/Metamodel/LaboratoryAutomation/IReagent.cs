...
namespace TTC2021.LabWorkflows.LaboratoryAutomation
{
    ...
    /// <summary>
    /// The public interface for Reagent
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Reagent))]
    [XmlDefaultImplementationTypeAttribute(typeof(Reagent))]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/ttc21/laboratoryAutomation#//Reagent")]
    public interface IReagent : IModelElement
    {
