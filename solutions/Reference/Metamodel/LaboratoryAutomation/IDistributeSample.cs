...
namespace TTC2021.LabWorkflows.LaboratoryAutomation
{
    ...
    /// <summary>
    /// The public interface for DistributeSample
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(DistributeSample))]
    [XmlDefaultImplementationTypeAttribute(typeof(DistributeSample))]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/ttc21/laboratoryAutomation#//Distribute" +
        "Sample")]
    public interface IDistributeSample : IModelElement, IProtocolStep
    {
