...
namespace TTC2021.LabWorkflows.JobCollection
{
    ...
    /// <summary>
    /// The public interface for TubeRunner
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(TubeRunner))]
    [XmlDefaultImplementationTypeAttribute(typeof(TubeRunner))]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/ttc21/jobCollection#//TubeRunner")]
    public interface ITubeRunner : IModelElement, ILabware
    {
        ...
        [ConstantAttribute()]
        IOrderedSetExpression<string> Barcodes
        {
            get;
        }
    }
