...
namespace TTC2021.LabWorkflows.JobCollection
{
    ...
    /// <summary>
    /// The public interface for LiquidTransferJob
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(LiquidTransferJob))]
    [XmlDefaultImplementationTypeAttribute(typeof(LiquidTransferJob))]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/ttc21/jobCollection#//LiquidTransferJob" +
        "")]
    public interface ILiquidTransferJob : IModelElement, IJob
    {
        ...
        [ConstantAttribute()]
        IOrderedSetExpression<ITipLiquidTransfer> Tips
        {
            get;
        }
