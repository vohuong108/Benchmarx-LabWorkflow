...
namespace TTC2021.LabWorkflows.JobCollection
{
    ...
    /// <summary>
    /// The default implementation of the Labware class
    /// </summary>
    ...
    [DebuggerDisplayAttribute("Labware {Name}")]
    public partial class Labware : ModelElement, ILabware, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://www.transformation-tool-contest.eu/ttc21/jobCollection#//Labware")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2021.LabWorkflows.JobCollection.Labware.ClassInstance)).Resolve("name")));
        }
        ...
        /// </summary>
        private sealed class NameProxy : ModelPropertyChange<ILabware, string>
        {
            ...
            public NameProxy(ILabware modelElement) : 
